...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-10 sm:py-12 md:py-14 lg:py-16 bg-cream relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.span
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-3 sm:px-5 py-2 bg-deep-green/10 text-deep-green font-handlee font-semibold text-xs sm:text-sm uppercase tracking-wider rounded-full"
          >
          ...
          >
            Ready to order? Contact us for bulk pricing, export inquiries, or any questions about our premium rice products.
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12">
              ...
              <div className="p-5 md:p-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-1">
                        <h4 className="font-cursive font-bold text-deep-green text-lg">Open 24 Hours</h4>
                        <motion.span
                  ...
                  >
                    <div className="w-14 h-14 bg-accent-gold/10 rounded-xl flex items-center justify-center flex-shrink-0">
                      <Building2 className="text-accent-gold" size={28} />
                    </div>
                    <div>
                      <h4 className="font-cursive font-bold text-deep-green text-lg mb-1">Office Address</h4>
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-cursive font-bold text-deep-green text-lg mb-1">Production Plant</h4>
                      <p className="text-gray-600 font-nunito text-sm leading-relaxed">
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-cursive font-bold text-deep-green text-lg mb-1">Phone</h4>
                      <a href="tel:+94672222540" className="text-gray-600 font-nunito text-sm hover:text-accent-gold transition-colors block">
                        0672 222 540
                      </a>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-cursive font-bold text-deep-green text-lg mb-1">Email</h4>
                      <a href="mailto:taasarice@gmail.com" className="text-gray-600 font-nunito text-sm hover:text-accent-gold transition-colors block">
                        taasarice@gmail.com
                      </a>
                    </div>
                  </motion.div>
                ...
                >
                  <a 
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-3 xs:py-4 px-2 xs:px-4 bg-green-500 text-white font-cursive font-bold text-center rounded-xl hover:bg-green-600 transition-all duration-300 shadow-lg hover:shadow-xl"
                  >
                    <WhatsAppSvgIcon />
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="bg-deep-green rounded-3xl p-8 md:p-12 h-full relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <form id="contact-form" onSubmit={handleSubmit} className="space-y-6" noValidate>
                      ...
                      <input
                        ...
                        className={`w-full px-6 py-4 bg-white/10 border rounded-xl text-white placeholder-white/50 font-nunito focus:outline-none transition-all duration-300 ${
                          errors.name && touched.name 
                            ...
                            : 'border-white/20 focus:border-accent-gold focus:bg-white/20'
                        }`}
                  ...
                  >
                    <motion.button
                      whileHover={!isSubmitting ? { scale: 1.02, boxShadow: '0 0 30px rgba(201, 162, 39, 0.5)' } : {}}
                      whileTap={!isSubmitting ? { scale: 0.98 } : {}}
                      type="submit"
                      disabled={isSubmitting}
                      className="w-full py-4 bg-accent-gold text-deep-green font-handlee font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-yellow-400 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      <Send size={20} />
                  ...
                  >
                    Or message directly on WhatsApp: <a href={`https://wa.me/${COMPANY_INFO.whatsappClean}`} className="text-accent-gold hover:underline">{COMPANY_INFO.whatsapp}</a>
                  </motion.p>
                </form>
